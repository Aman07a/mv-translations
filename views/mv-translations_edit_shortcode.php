...
if (isset($_POST['submitted'])) {
    ...
    if ($hasError === false) {
        ...
        global $post;
        $mv_translations_post_type = new MV_Translations_Post_Type(MV_TRANSLATIONS_PATH);
...
?>
    <div class="mv-translations">
        <form action="" method="POST" id="translations-form">
            ...
            <fieldset id="additional-fields">
                ...
                <select name="mv_translations_transliteration" id="mv_translations_transliteration">
                    <option value="Yes" <?php selected($results[0]['meta_value'], 'Yes'); ?>>
                        <?php esc_html_e('Yes', 'mv-translations'); ?>
                    </option>
                    <option value="No" <?php selected($results[0]['meta_value'], 'No'); ?>>
        ...
        <br>
        <a href="<?php echo esc_url(home_url('/submit-translation')); ?>">
            <?php esc_html_e('Back to translations list', 'mv-translations'); ?>
        </a>
    </div>
<?php  } ?>
<script>
