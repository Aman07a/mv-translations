...
<div class="mv-translations">
    <form action="" method="POST" id="translations-form">
        ...
        <?php
        if (isset($content)) {
            wp_editor($content, 'mv_translations_content', ['wpautop' => true, 'media_buttons' => true]);
        } else {
            wp_editor('', 'mv_translations_content', ['wpautop' => true, 'media_buttons' => true]);
        }
        ?>
        </br />
        ...
        <fieldset id="additional-fields">
            ...
            <select name="mv_translations_transliteration" id="mv_translations_transliteration">
                ...
                <option value="No" <?php if (isset($transliteration)) selected($transliteration, 'No'); ?>>
