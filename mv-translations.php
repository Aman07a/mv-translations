 ...
 * Author: Aman Ahmed
 * Author URI: https://github.com/Aman07a/mv-translations
...
if (!class_exists('MV_Translations')) {
    class MV_Translations
    {
        public function __construct()
        {
            ...
            $MVTranslationsEditShortcode = new MV_Translations_Edit_Shortcode(MV_TRANSLATIONS_PATH);
...
if (class_exists('MV_Translations')) {
    ...
    register_activation_hook(__FILE__, ['MV_Translations', 'activate']);
    register_deactivation_hook(__FILE__, ['MV_Translations', 'deactivate']);
    register_uninstall_hook(__FILE__, ['MV_Translations', 'uninstall']);
